...
# from libs import audiocraft
from models import AudioSealDetector, AudioSealWM, MsgProcessor
...
def create_generator(
    ...
    *,
    ...
    encoder = SEANetEncoder(**as_dict(config.seanet))
    ...
    decoder = SEANetDecoder(**as_dict(decoder_config))
